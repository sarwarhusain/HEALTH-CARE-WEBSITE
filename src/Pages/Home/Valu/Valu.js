      ...
      <div className="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div className="col">
          <div className="">
            ...
            <div className="">
              <h4>MRI/CT SCANE</h4>
              <p className="card-text">MRI is used to a great extent in modern hospitals and clinics for medical diagnosis, staging of disease and follow-up without exposing the body to ionizing radiation. It is painless and does not involve X-ray radiation. The images and resolution produced by MRI are extremely detailed and can detect tiny changes of structures within the body.
