      ...
      <div className="row row-cols-1 row-cols-md-2 g-4 ">
        <div className="col">
          <div className="card-body justify-content-start ">
            ...
            <h1 className="text-lg-start">Vision</h1>
            <p className="text-lg-start">The vision of Al Haramain Hospital is to lead the evolution of healthcare and be the most trusted health service provider in Bangladesh.</p>
            <h1 className="text-lg-start">Mission</h1>
            <p className="text-lg-start">The mission of Al Haramain Hospital is to provide quality health services and facilities for the community, to promote wellness, torelieve suffering and to restore health as swiftly, safely, and humanely as possible, consistent with the best service we can give and at the highest value.</p>
          </div>
        </div>
        <div className="col">
